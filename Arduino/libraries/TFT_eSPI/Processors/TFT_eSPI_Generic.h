...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  #else
    //#if defined(__AVR__) && !defined(__LGT8FX8P__)               // works, but slower (fillScreen 63)
    //#if defined(__AVR__) && !defined(__LGT8F__)                  // works, but slower (fillScreen 63)
    #ifdef __AVR__ // AVR processors do not have 16 bit transfer
      #ifdef __LGT8FX8P__                                          // LGT8FX8P (fillScreen 52)
